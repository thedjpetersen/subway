...
module.exports = function(client, data) {
  ...
  switch (args[0].toLowerCase()) {
    ...
    case "msg":
      /*
       * TODO fix adding/removing private channels
       * so they are maintained when you come back
    ...
    case "op":
      client.send.apply(client, ["MODE", data.target, "+o", args[1]]);
      break;
    ...
    case "voice":
      client.send.apply(client, ["MODE", data.target, "+v", args[1]]);
      break;
