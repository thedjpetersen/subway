...
module.exports = function(socket, app) {
  ...
  socket.on('register', function(data) {
    if(app.config.user_access.registration_enabled) {
      ...
      socket.emit('register_error', {message: 'Sorry, registration is disabled.'});
    }
  });

  // user login
  socket.on('login', function(data){
    if(app.config.user_access.users_enabled) {
      // find the user
      ...
      socket.emit('login_error', {message: 'Sorry, login is disabled.'});
    }
  });
