...
var logMessage = function(server, channel, attributes, username) {
  ...
  if(channel.indexOf("#") === -1) {
    var targetIs = [channel, attributes.from].sort().join("#");
...
var restore_connection = function(user, io, req) {
  ...
  var socket = _.find(io.sockets.sockets, function(sock) {
