...
var initialize = function(original_callback) {
  ...
  async.waterfall([
    ...
    function(additional_files, callback) {
      glob("src/new_components/**/*.jsx", {}, function(er, component_files) {
    ...
    function(additional_files, component_files, callback) {
      ...
      component_files = _.without(component_files, "src/new_components/irc.jsx").concat("src/new_components/irc.jsx");
