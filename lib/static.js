...
suspend(function*() {
  ...
  // We create arrays of all the files we need to concat and compile
  var er, additional_files = yield glob("src/js/**/*.js", {}, suspend.resumeRaw())
  var er, component_files = yield glob("src/components/**/*.jsx", {}, suspend.resumeRaw())

  // Our IRC react file needs to go last
  component_files = _.without(component_files[1], "src/components/irc.jsx").concat("src/components/irc.jsx");
