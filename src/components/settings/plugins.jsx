      ...
      return (
        <div className="menuPlugin">
          <div className="pluginButtons">
            {this.props.mode === "active" ? <a className="button pointer spacing-right" onClick={this.toggleSettings}>Settings</a> : ""}
            {!this.isActive() ? <a className="button pointer" onClick={this.togglePlugin}>{this.props.mode === "registry" ? "Add" : "Remove"}</a> : ""}
          </div>
          ...
          {function(cxt) {
            if(cxt.state.mode ==="active") {
              return (
                <div>
                  <div>
                    <a className="button pointer spacing-right" onClick={cxt.registry}>Registry</a>
                  ...
                  <div className="menuPlugins">
                    {cxt.getPlugins().map(function(plugin) {
                      return (
                        <Plugin plugin={plugin} mode={cxt.state.mode} toggleListener={cxt.pluginToggled} />
                      )
                    })}
              ...
              return (
                <div>
                  <div>
                    <a className="button pointer spacing-right" onClick={cxt.active}>Active Plugins</a>
                    <input placeholder="search" onChange={cxt.search} defaultValue={cxt.searchString}/>
                  </div>
                  <div className="menuPlugins">
                    {cxt.getPlugins().map(function(plugin) {
