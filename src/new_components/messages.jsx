app.components.KickMessage = React.createBackboneClass({
  render: function() {
    return (
...
app.components.ActionMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.NickMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.PartMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.QuitMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.JoinMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.TopicMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
        <div><strong>{this.getModel().get("nick")}</strong> has changed the topic to "{this.getModel().get("text")}"</div>
      </div>
    );
  }
});

app.components.ModeMessage = React.createBackboneClass({
  render: function() {
    return (
      <div className={this.getModel().getClass()}>
...
app.components.Message = React.createBackboneClass({
...
app.components.Messages = React.createBackboneClass({
  ...
  componentWillUpdate: function() {
    this.model_length = this.getCollection().length;
  ...
  componentDidUpdate: function() {
    ...
    var same_window = this.model_length === this.getCollection().length;

    if (this.shouldScrollBottom && same_window) {
      var node = this.getDOMNode();
      $(node).stop().animate({scrollTop: node.scrollHeight}, 300);
    }
      ...
      <div className="messages" onscroll={this.checkscroll}>
        {this.getCollection().map(function(message) {
          ...
          switch (message.get("type")) {
            case "PRIVMSG":
              return <app.components.Message model={message} />
            case "NOTICE":
              return <app.components.Message model={message} />
            case "MODE":
              return <app.components.ModeMessage model={message} />
            case "PART":
              return <app.components.PartMessage model={message} />
            case "QUIT":
              return <app.components.QuitMessage model={message} />
            case "KICK":
              return <app.components.KickMessage model={message} />
            case "JOIN":
              return <app.components.JoinMessage model={message} />
            case "TOPIC":
              return <app.components.TopicMessage model={message} />
            case "NICK":
              return <app.components.NickMessage model={message} />
            case "ACTION":
              return <app.components.ActionMessage model={message} />
          }
        })}
      </div>
    );
