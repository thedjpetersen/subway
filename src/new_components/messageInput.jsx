app.components.MessageBox = React.createBackboneClass({
...
app.components.NickBox = React.createBackboneClass({
  componentDidUpdate: function() {
...
app.components.MessageInput = React.createBackboneClass({
  ...
  render: function() {
    return (
      <div className="messageInput">
        <app.components.MessageBox history={this.state.history} historyMode={this.state.historyMode} historyOffset={this.state.historyOffset} />
        <app.components.NickBox selectUser={this.selectUser} nicks={this.state.nicks} selectedIndex={this.state.selectedIndex} tabMode={this.state.tabMode}/>
